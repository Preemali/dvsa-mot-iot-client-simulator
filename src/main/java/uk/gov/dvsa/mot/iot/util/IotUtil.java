...
public class IotUtil {
    ...
    private IotUtil(String propertyFile) {
        this.PROPERTY_FILE = propertyFile;
    }

    public static IotUtil getInstance(String propertyFile) {
        return new IotUtil(propertyFile);
    }
    ...
    public String getConfig(String name) {
        ...
        URL resource = IotUtil.class.getResource(PROPERTY_FILE);
        if (resource == null) {
            return null;
        }
    ...
    public KeyStorePasswordPair getKeyStorePasswordPair(final String certificateFile, final String privateKeyFile) {
    ...
    public KeyStorePasswordPair getKeyStorePasswordPair(final List<Certificate> certificates, final PrivateKey privateKey) {
        KeyStore keyStore;
        String keyPassword;
        try {
